...
const Delete = createLucideIcon("delete", __iconNode$k);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function NotificationContainer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed top-4 left-1/2 -translate-x-1/2 z-[200] flex flex-col gap-2 w-[360px] max-w-[90vw]", children: items.map((n) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: n.message }),
...
function useInactivity(timeout, onIdle) {
...
function AppLock({ onUnlocked }) {
  ...
  const title = mode === "set" ? "Set Your PIN" : mode === "confirm" ? "Confirm PIN" : "Enter PIN";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-[100] flex flex-col items-center justify-center bg-slate-950", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lock-icon-float lock-icon-glow inline-block mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-600 to-purple-900 flex items-center justify-center neon-purple", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { size: 32, className: "text-white" }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-black text-white", children: "WorkerSync Pro" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-500 text-sm mt-1", children: title })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-4 mb-6", children: [0, 1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: cn(
          "w-4 h-4 rounded-full border-2 transition-all duration-200",
          pin.length > i ? "bg-purple-500 border-purple-400 neon-purple" : "bg-transparent border-slate-600"
        )
      },
      i
    )) }),
    ...
    lockoutEnd && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "p",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-3 w-64", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Delete, { size: 20 })
        }
      )
    ] })
  ] });
...
function generateId() {
  const prefix2 = ["USR", "EMP", "SYN"][Math.floor(Math.random() * 3)];
...
function AuthPage({ onLogin }) {
  ...
  const [idCode, setIdCode] = reactExports.useState("");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col min-h-full bg-slate-950 px-6 py-10 items-center justify-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-600 to-blue-700 mb-4 neon-purple", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 30, className: "text-white" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-black text-white tracking-tight", children: "WorkerSync Pro" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-500 text-sm mt-1", children: "Team management & coordination" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-sm flex flex-col gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-xs font-semibold text-slate-400 mb-1.5 uppercase tracking-wider", children: "Your Name" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-xs font-semibold text-slate-400 mb-1.5 uppercase tracking-wider", children: "Unique ID Code" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-xs font-semibold text-slate-400 mb-1.5 uppercase tracking-wider", children: "Select Role" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2", children: roles.map((r2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            onClick: () => setRole(r2.value),
            className: cn(
              "flex items-center gap-3 px-4 py-3 rounded-xl border bg-slate-900 transition-all text-left",
              r2.glow,
              role === r2.value ? cn(r2.border, "bg-slate-800") : "border-slate-700 hover:border-slate-600"
            ),
            "data-ocid": `auth.${r2.value.toLowerCase()}.toggle`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: cn(
                    ...
                    role === r2.value ? cn("bg-current border-current", r2.color) : "border-slate-600"
                  )
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    className: cn(
                      ...
                      role === r2.value ? r2.color : "text-white"
                    ),
                    children: r2.label
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-500 text-xs", children: r2.desc })
              ] })
            ]
          },
          r2.value
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center text-slate-600 text-xs", children: [
        "Demo: Use ID ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-purple-400 font-mono", children: "OWN001" }),
        " ",
...
function StatusBadge({ status, className }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "span",
    {
      ...
      children: [
        status === "online" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: cn(
...
function getMessages(myId, peerId) {
  const all = JSON.parse(
    localStorage.getItem("workersync_messages") ?? "[]"
  );
  return all.filter(
    (m) => m.senderId === myId && m.receiverId === peerId || m.senderId === peerId && m.receiverId === myId
  ).sort((a, b) => a.timestamp - b.timestamp);
}
function isBlocked(myId, peerId) {
  const blocked = JSON.parse(
    localStorage.getItem("workersync_blocked") ?? "[]"
  );
  return blocked.some(
    (b) => b.blockerId === myId && b.blockedId === peerId || b.blockerId === peerId && b.blockedId === myId
  );
}
...
function ChatRoom({ session, peer, onBack }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full bg-slate-950", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-4 py-3 border-b border-slate-800 bg-slate-950/90 backdrop-blur-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(UserAvatar, { name: peer.name, role: peer.role, size: "sm" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-white text-sm", children: peer.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBadge, { status: peer.status, className: "text-xs" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto px-4 py-3 flex flex-col gap-3", children: [
      messages.map((m) => {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: cn(
                    ...
                    isMine ? "bg-gradient-to-br from-purple-700 to-blue-700 text-white rounded-br-sm" : "bg-slate-800 text-slate-100 rounded-bl-sm"
                  ),
                  children: m.content
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-slate-600", children: formatTime(m.timestamp) })
            ]
          },
          m.id
        );
      }),
      messages.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-slate-600 text-sm mt-8", children: "No messages yet. Say hello!" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: bottomRef })
    ] }),
    blocked ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-4 border-t border-slate-800 text-center text-slate-500 text-sm", children: "🚫 Chat is blocked" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 border-t border-slate-800 flex items-center gap-2 bg-slate-950", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                titleIcon && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cfg.title, children: titleIcon }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: cn("font-bold text-sm", cfg.title), children: title })
              ] }),
              headerExtra
            ]
          }
...
const NAV$2 = [
  { id: "trip", label: "Trip", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Truck, { size: 18 }) },
  { id: "chat", label: "Chat", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, { size: 18 }) },
  { id: "location", label: "Location", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 18 }) },
  { id: "profile", label: "Profile", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(User, { size: 18 }) }
];
function getMyTask(idCode) {
  const all = JSON.parse(
    localStorage.getItem("workersync_tasks") ?? "[]"
  );
  return all.find(
    (t) => t.assignedTo === idCode && t.status !== "completed" && t.status !== "rejected"
  ) ?? null;
}
function getOwner$1() {
...
function addLog$1(action, details, session) {
...
function DriverDashboard({
  ...
  const [tab, setTab] = reactExports.useState("trip");
  ...
  const locInterval = reactExports.useRef(null);
  const owner = getOwner$1();
  function updateTask(newStatus) {
    if (!task) return;
    const all = JSON.parse(
      localStorage.getItem("workersync_tasks") ?? "[]"
    );
    const updated = all.map(
      (t) => t.id === task.id ? { ...t, status: newStatus } : t
    );
    localStorage.setItem("workersync_tasks", JSON.stringify(updated));
    const refreshed = updated.find((t) => t.id === task.id) ?? null;
    setTask(
      (refreshed == null ? void 0 : refreshed.status) !== "completed" && (refreshed == null ? void 0 : refreshed.status) !== "rejected" ? refreshed : null
    );
    addLog$1("Trip Updated", `Delivery status → ${newStatus}`, session);
    showNotification(
  ...
  function toggleSharing() {
    ...
    if (!isSharing) {
      ...
      locInterval.current = setInterval(() => {
        setCoords(
          (prev) => prev ? { lat: prev.lat + 2e-4, lng: prev.lng + 1e-4 } : null
        );
      }, 15e3);
      showNotification("Live location sharing started", "success");
      addLog$1("Location Shared", "Driver started sharing location", session);
    } else {
      setIsSharing(false);
  ...
  function toggleStatus() {
    ...
    const updated = users.map(
      (u) => u.idCode === session.idCode ? { ...u, status: next } : u
    );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full bg-slate-950", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 border-b border-slate-800 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-xl bg-gradient-to-br from-cyan-600 to-cyan-900 flex items-center justify-center neon-cyan", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 16, className: "text-white" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-bold text-sm", children: session.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-cyan-400 text-xs", children: [
            session.role,
            " · ",
            session.idCode
          ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto", children: [
      tab === "trip" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex flex-col gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-white font-black text-xl", children: "Current Delivery" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              ...
              children: task ? `Status: ${task.status}` : "No active delivery"
            }
          )
        ] }),
        task ? /* @__PURE__ */ jsxRuntimeExports.jsx(NeonCard, { variant: "cyan", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-cyan-300 text-xs font-semibold uppercase tracking-wider mb-1", children: "Delivery Task" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-bold text-base", children: task.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-500 text-sm mt-0.5", children: task.description })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-slate-900/80 rounded-xl p-3 flex flex-col gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-6 h-6 rounded-full bg-blue-950/60 border border-blue-500/30 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-blue-400 text-xs font-bold", children: "P" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-500 text-xs", children: "Pickup" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white text-sm font-medium", children: task.pickupLocation || "Not specified" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-4 border-l border-dashed border-slate-700 ml-3" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-6 h-6 rounded-full bg-green-950/60 border border-green-500/30 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-400 text-xs font-bold", children: "D" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-500 text-xs", children: "Drop-off" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white text-sm font-medium", children: task.dropLocation || "Not specified" })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBadge, { status: task.status })
        ] }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(NeonCard, { variant: "cyan", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "text-center py-6 text-slate-600",
            "data-ocid": "driver.trip.empty_state",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Truck, { size: 40, className: "mx-auto mb-3 opacity-30" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: "No active delivery" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-1", children: "Waiting for task assignment" })
            ]
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3", children: [
          (task == null ? void 0 : task.status) === "pending" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
          ...
          (task == null ? void 0 : task.status) === "accepted" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
          ...
          (task == null ? void 0 : task.status) === "inProgress" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
      ...
      tab === "chat" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex flex-col gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-white font-black text-xl", children: "Chat" }),
        owner ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(UserAvatar, { name: owner.name, role: owner.role }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-semibold", children: owner.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBadge, { status: owner.status })
              ] })
            ]
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-600 text-sm", children: "Owner not found." })
      ] }),
      tab === "location" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex flex-col gap-4 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-white font-black text-xl self-start", children: "Live Location" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(NeonCard, { variant: "cyan", className: "w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-4 py-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: cn(
                "w-24 h-24 rounded-full flex items-center justify-center transition-all",
                isSharing ? "bg-green-950/60 border-2 border-green-500/60" : "bg-slate-800 border-2 border-slate-700"
              ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: isSharing ? "LIVE" : "OFF"
              }
            ),
            coords && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-slate-500 text-xs font-mono mt-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              className: cn(
                ...
                isSharing ? "bg-red-600 hover:bg-red-500" : "bg-green-600 hover:bg-green-500"
              ),
              "data-ocid": "driver.location.toggle",
              children: isSharing ? "Stop Sharing" : "Share Live Location"
            }
          )
        ] }) })
      ] }),
      tab === "profile" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex flex-col gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-white font-black text-xl", children: "My Profile" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(NeonCard, { variant: "cyan", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3 py-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(UserAvatar, { name: session.name, role: session.role, size: "lg" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-bold text-lg", children: session.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-cyan-400 text-sm", children: session.role }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-500 text-xs font-mono mt-1", children: session.idCode })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBadge, { status })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(NeonCard, { variant: "green", title: "Status Control", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-300 text-sm", children: status === "online" ? "Available" : "Unavailable" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              ...
              className: cn(
                ...
                status === "online" ? "bg-red-950/60 border border-red-500/30 text-red-300" : "bg-green-950/60 border border-green-500/30 text-green-300"
              ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-slate-800 bg-slate-950/95 px-2 py-2 flex justify-around", children: NAV$2.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        onClick: () => {
        ...
        className: cn(
          ...
          tab === n.id ? "text-cyan-400 bg-cyan-950/40" : "text-slate-500 hover:text-slate-300"
        ),
        "data-ocid": `driver.${n.id}.tab`,
        children: [
          n.icon,
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-medium", children: n.label })
        ]
      },
      n.id
    )) })
...
const NAV$1 = [
  ...
  { id: "team", label: "Team", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { size: 18 }) },
  { id: "tasks", label: "Tasks", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ClipboardList, { size: 18 }) },
  { id: "map", label: "Map", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 18 }) },
  { id: "chat", label: "Chat", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, { size: 18 }) },
  { id: "logs", label: "Logs", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { size: 18 }) }
];
const STATUS_COLORS = {
...
function OwnerDashboard({
  ...
  const [workers, setWorkers] = reactExports.useState(getWorkers);
  const [tasks, setTasks] = reactExports.useState(getTasks);
  const [logs, setLogs] = reactExports.useState(getLogs);
  const [chatPeer, setChatPeer] = reactExports.useState(null);
  const [showWorkerModal, setShowWorkerModal] = reactExports.useState(false);
  const [editWorker, setEditWorker] = reactExports.useState(null);
  const [wForm, setWForm] = reactExports.useState({
    name: "",
    phone: "",
    role: "Worker",
    idCode: ""
  });
  const [showTaskModal, setShowTaskModal] = reactExports.useState(false);
  ...
  function toggleBlock(worker) {
    const updated = workers.map(
      (w) => w.id === worker.id ? { ...w, isBlocked: !w.isBlocked } : w
    );
    storeWorkers(updated);
    setWorkers(updated);
    const blocked = JSON.parse(
  ...
  function saveTaskForm() {
    ...
    const newTask = {
      id: Math.random().toString(36).slice(2),
      ...tForm,
      assignedToName: (assignee == null ? void 0 : assignee.name) ?? tForm.assignedTo,
      status: "pending",
      date: Date.now()
    };
  ...
  if (chatPeer && tab === "chat") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      ChatRoom,
      {
        session,
        peer: chatPeer,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full bg-slate-950", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 border-b border-slate-800 flex items-center justify-between bg-slate-950/95", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-xl bg-gradient-to-br from-purple-600 to-blue-700 flex items-center justify-center neon-purple", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 16, className: "text-white" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-bold text-sm leading-tight", children: "WorkerSync Pro" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-purple-400 text-xs", children: [
            session.name,
            " · ",
            session.role
          ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto", children: [
      tab === "dashboard" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        DashboardTab,
        {
          totalWorkers,
          activeWorkers,
      ...
      tab === "team" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        TeamTab,
        {
          workers,
          users,
      ...
      tab === "tasks" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        TasksTab,
        {
          tasks,
          workers,
      ...
      tab === "map" && /* @__PURE__ */ jsxRuntimeExports.jsx(MapTab, { locations, workers }),
      tab === "chat" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        ChatListTab,
        {
          workers,
          users,
      ...
      tab === "logs" && /* @__PURE__ */ jsxRuntimeExports.jsx(LogsTab, { logs })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-slate-800 bg-slate-950/95 px-2 py-2 flex justify-around", children: NAV$1.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        onClick: () => {
        ...
        className: cn(
          "flex flex-col items-center gap-0.5 px-3 py-1.5 rounded-xl transition-all",
          tab === n.id ? "text-purple-400 bg-purple-950/40" : "text-slate-500 hover:text-slate-300"
        ),
    ...
    showWorkerModal && /* @__PURE__ */ jsxRuntimeExports.jsx(
      Modal,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3", children: [
          ["name", "phone", "idCode"].map((field) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-slate-400 uppercase tracking-wider", children: field === "idCode" ? "ID Code" : field.charAt(0).toUpperCase() + field.slice(1) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                ...
                value: wForm[field],
                onChange: (e) => setWForm((prev) => ({ ...prev, [field]: e.target.value })),
                "data-ocid": `worker_form.${field}.input`
              }
            )
          ] }, field)),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-slate-400 uppercase tracking-wider", children: "Role" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "select",
              {
                className: "w-full mt-1 bg-slate-800 border border-slate-700 rounded-xl px-3 py-2 text-white text-sm outline-none",
                value: wForm.role,
                onChange: (e) => setWForm((prev) => ({
                  ...prev,
                  role: e.target.value
                })),
                "data-ocid": "worker_form.role.select",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Worker", children: "Worker" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: editWorker ? "Save Changes" : "Add Worker"
            }
          )
        ] })
      }
    ),
    showTaskModal && /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { onClose: () => setShowTaskModal(false), title: "Assign New Task", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3", children: [
      ["title", "description"].map((field) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-slate-400 uppercase tracking-wider", children: field.charAt(0).toUpperCase() + field.slice(1) }),
        field === "description" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
            rows: 2,
            ...
            value: tForm[field],
            onChange: (e) => setTForm((p) => ({ ...p, [field]: e.target.value })),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-slate-400 uppercase tracking-wider", children: "Assign To" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
            className: "w-full mt-1 bg-slate-800 border border-slate-700 rounded-xl px-3 py-2 text-white text-sm outline-none",
            ...
            children: [
              ...
              workers.map((w) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: w.idCode, children: [
                w.name,
                " (",
                w.role,
                ")"
      ...
      ["pickupLocation", "dropLocation"].map((field) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-slate-400 uppercase tracking-wider", children: field === "pickupLocation" ? "Pickup Location" : "Drop Location" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            className: "w-full mt-1 bg-slate-800 border border-slate-700 rounded-xl px-3 py-2 text-white text-sm outline-none focus:border-blue-500/70",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-slate-900 border border-slate-700 rounded-t-3xl w-full max-w-[430px] p-6 max-h-[85vh] overflow-y-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-white font-bold text-lg", children: title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
...
function StatCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(NeonCard, { variant, className: "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: cn("text-3xl font-black", colors[variant]), children: value }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white text-xs font-semibold mt-1", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-500 text-xs", children: sub })
  ] }) });
}
function DashboardTab({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex flex-col gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-white font-black text-xl", children: "Admin Dashboard" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-500 text-sm", children: "Overview of your team" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        StatCard,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      NeonCard,
      {
        ...
        titleIcon: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { size: 14 }),
        children: [
          logs.slice(0, 5).map((log2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: cn(
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full bg-purple-950/60 border border-purple-500/30 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { size: 12, className: "text-purple-400" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white text-xs font-semibold", children: log2.action }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-500 text-xs truncate", children: log2.details }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-600 text-xs", children: new Date(log2.timestamp).toLocaleString() })
                ] })
              ]
            },
            log2.id
          )),
          logs.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-600 text-sm", children: "No activity yet." })
        ]
      }
    )
  ] });
...
function TeamTab({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex flex-col gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-white font-black text-xl", children: "Team" }),
    ...
    workers.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No workers yet." })
        ]
      }
    ),
    workers.map((w, i) => {
        ...
        NeonCard,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(UserAvatar, { name: w.name, role: w.role }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-bold text-sm", children: w.name }),
                  w.isBlocked && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-red-400 bg-red-950/60 px-2 py-0.5 rounded-full", children: "Blocked" })
                ] }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-600 text-xs font-mono", children: maskPhone(w.phone) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  StatusBadge,
                  {
                    status: (user == null ? void 0 : user.status) ?? w.status,
                    className: "mt-1"
                  }
                )
              ] })
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  className: cn(
                    ...
                    w.isBlocked ? "bg-green-950/60 border-green-500/30 text-green-400" : "bg-pink-950/60 border-pink-500/30 text-pink-400"
                  ),
                  "data-ocid": `team.block.button.${i + 1}`,
                  children: w.isBlocked ? /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { size: 14 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Ban, { size: 14 })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
...
function TasksTab({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex flex-col gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-white font-black text-xl", children: "Tasks" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-slate-500 text-sm", children: [
          tasks.length,
          " total"
        ] })
    ...
    tasks.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(NeonCard, { variant: "blue", "data-ocid": `tasks.item.${i + 1}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          CircleCheck,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-semibold text-sm", children: t.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-500 text-xs mt-0.5", children: t.description }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-1.5 flex-wrap", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-600 text-xs", children: t.assignedToName }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-700 text-xs", children: fmtDate(t.date) })
          ] }),
          t.pickupLocation && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-slate-600 text-xs mt-1", children: [
            "📦 ",
            t.pickupLocation,
            " → ",
            t.dropLocation
      ...
      t.status !== "completed" && t.status !== "rejected" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 mt-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
    ...
    workers.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden" })
  ] });
}
function MapTab({
  locations,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex flex-col gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-white font-black text-xl", children: "Live Map" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-slate-500 text-sm", children: [
        sharingLocs.length,
        " location(s) active"
      ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      NeonCard,
      {
        ...
        titleIcon: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 14 }),
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "svg",
                {
                  ...
                  children: [
                    [0, 1, 2, 3, 4].map((r2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "line",
                      {
                        x1: "0",
                        y1: r2 * 60,
                    ...
                    [0, 1, 2, 3, 4, 5].map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "line",
                      {
                        x1: c * 60,
                        y1: "0",
                    ...
                    sharingLocs.map((loc, i) => {
                      ...
                      return /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: x, cy: y, r: "6", fill: color, fillOpacity: "0.9" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: x, cy: y, r: "3", fill: "white" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "text",
                          {
                            x,
                            ...
                            fontSize: "9",
                            fontWeight: "600",
                            children: (wk == null ? void 0 : wk.name) ?? loc.userId
                          }
                        )
                      ] }, loc.userId);
                    }),
                    sharingLocs.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "text",
                      {
                        x: "150",
                        y: "125",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 flex flex-col gap-2", children: sharingLocs.map((loc) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 rounded-full bg-cyan-400 status-online-dot" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-medium", children: (wk == null ? void 0 : wk.name) ?? loc.userId }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-slate-500", children: [
                loc.latitude.toFixed(4),
                ", ",
                loc.longitude.toFixed(4)
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-600 ml-auto", children: new Date(loc.timestamp).toLocaleTimeString() })
            ] }, loc.userId);
          }) })
        ]
      }
...
function ChatListTab({
  ...
  const messages = JSON.parse(localStorage.getItem("workersync_messages") ?? "[]");
  function getLastMsg(peerId) {
    return messages.filter(
      (m) => m.senderId === session.idCode && m.receiverId === peerId || m.senderId === peerId && m.receiverId === session.idCode
    ).sort((a, b) => b.timestamp - a.timestamp)[0];
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex flex-col gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-white font-black text-xl", children: "Chats" }),
    workers.map((w, i) => {
      const user = users.find((u) => u.idCode === w.idCode);
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-semibold text-sm", children: w.name }),
                lastMsg && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-600 text-xs", children: new Date(lastMsg.timestamp).toLocaleTimeString([], {
                  hour: "2-digit",
                  minute: "2-digit"
                }) })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-500 text-xs truncate mt-0.5", children: (lastMsg == null ? void 0 : lastMsg.content) ?? "No messages yet" })
            ] })
          ]
        },
        w.id
...
function LogsTab({ logs }) {
  const ICONS = {
    "Task Created": /* @__PURE__ */ jsxRuntimeExports.jsx(ClipboardList, { size: 12, className: "text-blue-400" }),
    "Task Accepted": /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { size: 12, className: "text-green-400" }),
    "Location Shared": /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 12, className: "text-cyan-400" }),
    "Message Sent": /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, { size: 12, className: "text-pink-400" }),
    "Status Changed": /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 12, className: "text-amber-400" })
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex flex-col gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-white font-black text-xl", children: "Activity Log" }),
    logs.map((log2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "flex items-start gap-3 p-3 rounded-xl bg-slate-900 border border-slate-800",
        "data-ocid": `logs.item.${i + 1}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-full bg-slate-800 border border-slate-700 flex items-center justify-center flex-shrink-0", children: ICONS[log2.action] ?? /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { size: 12, className: "text-slate-400" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white text-xs font-semibold", children: log2.action }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-600 text-xs", children: new Date(log2.timestamp).toLocaleTimeString() })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-500 text-xs", children: log2.details }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-purple-400/60 text-xs", children: [
              "by ",
              log2.userName
            ] })
          ] })
    ...
    logs.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { size: 32, className: "mx-auto mb-2 opacity-40" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No activity logged yet." })
        ]
      }
    )
  ] });
...
function addLog(action, details, session) {
  const logs = JSON.parse(localStorage.getItem("workersync_logs") ?? "[]");
  logs.unshift({
    id: Math.random().toString(36).slice(2),
    userId: session.idCode,
...
function WorkerDashboard({ session, onLogout }) {
  const [tab, setTab] = reactExports.useState("tasks");
  const [tasks, setTasks] = reactExports.useState(() => getMyTasks(session.idCode));
  const [chatOpen, setChatOpen] = reactExports.useState(false);
  const [isSharing, setIsSharing] = reactExports.useState(false);
  const [coords, setCoords] = reactExports.useState(
    null
  ...
  const [status, setStatus] = reactExports.useState("online");
  const locationInterval = reactExports.useRef(null);
  ...
  function toggleLocationSharing() {
    ...
    if (!isSharing) {
      ...
      locationInterval.current = setInterval(() => {
        var _a3;
        (_a3 = navigator.geolocation) == null ? void 0 : _a3.getCurrentPosition(
          (pos) => {
            const c = { lat: pos.coords.latitude, lng: pos.coords.longitude };
            setCoords(c);
            saveLocation(c);
          ...
          () => {
            setCoords(
              (prev) => prev ? { lat: prev.lat + 1e-4, lng: prev.lng + 1e-4 } : null
            );
          }
        );
      }, 15e3);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full bg-slate-950", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 border-b border-slate-800 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-xl bg-gradient-to-br from-blue-600 to-blue-900 flex items-center justify-center neon-blue", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 16, className: "text-white" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-bold text-sm", children: session.name }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto", children: [
      tab === "tasks" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex flex-col gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-white font-black text-xl", children: "My Tasks" }),
        tasks.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "text-center py-12 text-slate-600",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ClipboardList, { size: 32, className: "mx-auto mb-2 opacity-40" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No tasks assigned yet." })
            ]
          }
        ),
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBadge, { status: t.status, className: "mt-1.5" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 mt-3", children: [
                t.status === "pending" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                ...
                t.status === "accepted" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                ...
                t.status === "inProgress" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                ...
                (t.status === "completed" || t.status === "rejected") && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-600 text-xs text-center w-full py-1", children: t.status === "completed" ? "✅ Completed" : "❌ Rejected" })
              ] })
            ]
          },
          t.id
      ...
      tab === "chat" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex flex-col gap-3", children: [
        ...
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-600 text-sm", children: "No owner found." })
      ] }),
      tab === "location" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex flex-col gap-4 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-white font-black text-xl self-start", children: "Live Location" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(NeonCard, { variant: "cyan", className: "w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-4 py-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: cn(
                ...
                isSharing ? "bg-green-950/60 border-2 border-green-500/60 neon-green" : "bg-slate-800 border-2 border-slate-700"
              ),
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Navigation,
                {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: isSharing ? "Sharing Live Location" : "Location Sharing OFF"
              }
            ),
            coords && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-slate-500 text-sm font-mono mt-1", children: [
              coords.lat.toFixed(5),
              ", ",
              coords.lng.toFixed(5)
            ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              className: cn(
                "w-full py-4 rounded-2xl font-bold text-white text-base transition-all active:scale-95",
                isSharing ? "bg-red-600 hover:bg-red-500 neon-pink" : "bg-green-600 hover:bg-green-500 neon-green"
              ),
              "data-ocid": "worker.location.toggle",
              children: isSharing ? "Stop Sharing" : "Share Live Location"
            }
          ),
          isSharing && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-600 text-xs", children: "Updates every 15 seconds" })
        ] }) })
      ] }),
      tab === "profile" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex flex-col gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-white font-black text-xl", children: "My Profile" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(NeonCard, { variant: "blue", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3 py-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(UserAvatar, { name: session.name, role: session.role, size: "lg" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-bold text-lg", children: session.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-blue-400 text-sm", children: session.role }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-500 text-xs font-mono mt-1", children: session.idCode })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBadge, { status })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(NeonCard, { variant: "cyan", title: "Status", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-300 text-sm", children: status === "online" ? "You are Online" : "You are Offline" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-slate-800 bg-slate-950/95 px-2 py-2 flex justify-around", children: NAV.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        onClick: () => {
        ...
        className: cn(
          "flex flex-col items-center gap-0.5 px-3 py-1.5 rounded-xl transition-all",
          tab === n.id ? "text-blue-400 bg-blue-950/40" : "text-slate-500 hover:text-slate-300"
        ),
...
function App() {
  const [session, setSession] = reactExports.useState(getStoredSession);
  const [locked, setLocked] = reactExports.useState(false);
  const [pinSetup, setPinSetup] = reactExports.useState(false);
  const handleIdle = reactExports.useCallback(() => {
    if (session && localStorage.getItem("workersync_pin_set") === "true") {
      setLocked(true);
    }
  }, [session]);
  useInactivity(6e4, handleIdle);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-slate-950 flex items-center justify-center p-0 sm:p-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        style: {
          boxShadow: "0 0 60px rgba(168,85,247,0.15), 0 0 120px rgba(139,92,246,0.08)"
        },
        children: [
          !session && /* @__PURE__ */ jsxRuntimeExports.jsx(AuthPage, { onLogin: handleLogin }),
          session && showLock && /* @__PURE__ */ jsxRuntimeExports.jsx(AppLock, { onUnlocked: handleUnlocked }),
          session && !showLock && session.role === "Owner" && /* @__PURE__ */ jsxRuntimeExports.jsx(OwnerDashboard, { session, onLogout: handleLogout }),
          session && !showLock && session.role === "Worker" && /* @__PURE__ */ jsxRuntimeExports.jsx(WorkerDashboard, { session, onLogout: handleLogout }),
          session && !showLock && session.role === "Driver" && /* @__PURE__ */ jsxRuntimeExports.jsx(DriverDashboard, { session, onLogout: handleLogout })
        ]
      }
    ),
...
Service({
  ...
  "addLog": Func([Text, Text], [], []),
  "assignCallerUserRole": Func([Principal2, UserRole], [], []),
  "broadcastMessage": Func(
    [Vec(Principal2), Text, MessageType, Opt(ExternalBlob)],
    [],
    []
  ),
  "createTask": Func([Task], [Text], []),
  "deleteFile": Func([Text], [], []),
  "getActiveWorkerCount": Func([], [Nat], ["query"]),
  "getAllLogs": Func([], [Vec(LogEntry)], ["query"]),
  "getAllTasks": Func([], [Vec(Task)], ["query"]),
  "getCallerUserProfile": Func([], [Opt(Profile)], ["query"]),
  "getCallerUserRole": Func([], [UserRole], ["query"]),
  "getFiles": Func([MessageType], [Vec(Message)], ["query"]),
  ...
  "getUser": Func([Principal2], [Profile], ["query"]),
  "getUserLocation": Func([Principal2], [Location], ["query"]),
  "getUserLogs": Func([Principal2], [Vec(LogEntry)], ["query"]),
  "getUserProfile": Func([Principal2], [Opt(Profile)], ["query"]),
  "isCallerAdmin": Func([], [Bool], ["query"]),
  "registerUser": Func([RegisterUserInput], [], []),
  "saveCallerUserProfile": Func([Profile], [], []),
  "sendMessage": Func(
    [Principal2, Text, MessageType, Opt(ExternalBlob)],
    [],
    []
  ),
  "toggleLocationSharing": Func([Bool], [], []),
  "updateMyLocation": Func([Int, Int], [], []),
  "updateMyStatus": Func([Status__1], [], []),
  "updateTaskStatus": Func([Text, Status], [], []),
  "uploadFile": Func([Text, Text, ExternalBlob], [], [])
});
